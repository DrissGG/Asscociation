    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark ">
        ...
        <div class="collapse navbar-collapse  justify-content-center" id="navbarNav">
            <ul class="navbar-nav  ">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="lien/aide_devoir.php">Aide au devoir</a>
                </li>
                <li class="nav-item">
...
<footer class="bg-dark text-white py-3">
    <div class="container">
        <p class="text-center">Contact: contact@example.com</p>
        <p class="text-center">Adresse: 123 Main St, New York, NY 10001</p>
    </div>
</footer>
